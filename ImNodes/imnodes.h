...
enum ImNodesAttributeFlags_
{
    ...
    // for previewing the creation of a link while dragging it across Attribute. See here for demo:
...
// following function calls. These functions have to be called before adding any Attribute, or the
// layout of the node will be incorrect.
void BeginNodeTitleBar();
void EndNodeTitleBar();

// Attribute are ImGui UI elements embedded within the node. Attribute can have pin shapes
...
// Render a link between Attribute.
// The Attribute ids used here must match the ids used in Begin(Input|Output)Attribute function

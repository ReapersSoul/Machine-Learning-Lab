...
#include "../LibraryInterface/LibraryInterface.hpp"
#include "../Languages/LanguageInterface/LanguageInterface.hpp"
#include "../ScriptInterface/ScriptInterface.hpp"
#include "../../../SerializableInterface/SerializableInterface.hpp"
#include "../KernelInterface/KernelInterface.hpp"
	...
	static void ReLoadEngine() {
		if(EngineLibrary != nullptr) {
			...
			delete EngineLibrary;
				...
				EngineLibrary = new boost::dll::shared_library("Core/libDynamicCodeExecutionEngine.so");
			#endif
